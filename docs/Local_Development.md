...
- voting session creation, vote submission, results aggregation, and AI backend routes
...
Voting, results, and AI should currently be treated as staged shells rather than complete local flows.
